...
public class GridRepoSample extends GridRepo {
    private final EntityCode[][] level1 = {
            ...
            {Monster, Empty, Empty, Empty, Box, Empty, Empty, Empty, BombBagCapacityInc, Empty, Empty, Monster}
    };
    ...
    @Override public final Grid load(int level, String name) {
        ...
        for (int i = 0; i < width; i++) {
            for (int j = 0; j < height; j++) {
                Position position = new Position(1, i, j);
