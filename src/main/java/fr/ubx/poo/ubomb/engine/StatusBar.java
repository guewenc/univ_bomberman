...
public class StatusBar {
    ...
    public void update(Game game) {
        ...
        lives.setText("" + game.getPlayer().getLives());
        bombRange.setText("" + game.getPlayer().getBombRange());
        availableBombs.setText("" + game.getPlayer().getBombBagCapacity());
        keys.setText("" + game.getPlayer().getNbKeys());
    }
}